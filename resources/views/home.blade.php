            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="client_review_slider owl-carousel owl-loaded owl-drag">
                        ...
                        <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-1220px, 0px, 0px); transition: all 0.25s ease 0s; width: 4270px;"><div class="owl-item cloned" style="width: 610px;"><div class="single_client_review" dir="rtl">
                                        <div class="client_img">
                                            <img src="img/client_1.png" alt="#">
                                        </div>
                                        <p>"برای جلوگیری از گردن درد گزینه های مناسبی هستند.</p>
                                        <h5>- امیر امیری</h5>
                                    </div></div><div class="owl-item cloned" style="width: 610px;"><div class="single_client_review" dir="rtl">
                                        <div class="client_img">
                                            <img src="img/client_2.png" alt="#">
                                        </div>
                                        <p>"برای نشستن های طولانی مدت روی مبل قابل قبول اند.</p>
                                        <h5>- محمد موسوی</h5>
                                    </div></div><div class="owl-item active" style="width: 610px;"><div class="single_client_review" dir="rtl">
                                        <div class="client_img">
                                            <img src="img/client.png" alt="#">
                                        </div>
                                        <p>"استفاده از بالش های طبی را در سفرهای طولانی مدت پیشنهاد می کنم.</p>
                                        <h5>- رضا محمدی</h5>
                                    </div></div><div class="owl-item" style="width: 610px;"><div class="single_client_review" dir="rtl">
                                        <div class="client_img">
                                            <img src="img/client_1.png" alt="#">
                                        </div>
                                        <p>"برای جلوگیری از گردن درد گزینه های مناسبی هستند.</p>
